...
*This story was extracted from a broader evaluation covering 320,192 evaluations, 1,392 benchmark items, and 1,062 GPU hours of compute. An evaluation is one question × seed × configuration: one model attempt at one benchmark item under one configuration and one of the eight fixed seeds, and the 320,192 evaluations are the 40,024 question-configuration pairs, each run under all eight seeds. The full report (report.md) covers seven findings: The Irrelevance Paradox, The Jinja Fix, Wire API Differences, Multi-Turn Base (Agentic Work), Preserved Thinking, Not All Reasoning is Created Equal, and Python Tool Impact. This story is Finding 6, the most transferable of the seven, presented here as a standalone analysis.*
